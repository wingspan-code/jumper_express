...
export const DelayedReply = async (appId, token, message) => {
  return DiscordRequest(process.env.DISCORD_TOKEN)(`interactions/${appId}/${token}/callback`, {method: 'POST', body: message})
}
